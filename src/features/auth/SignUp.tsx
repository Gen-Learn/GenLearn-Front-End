...
function SignUp() {
  ...
  const passwordStrength = () => {
    ...
    if (form.password.length < 10) return { strength: 'medium', color: 'bg-amber-500', width: 'w-2/3' };
    ...
    <div className="min-h-screen bg-[#FAFAFC] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-primary-500 to-secondary-500 p-12 flex-col justify-between">
        ...
        <div className="relative z-10 text-white">
          <p className="text-xl font-medium mb-2">"Start your learning journey today"</p>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Start transforming your PDFs into courses</p>
          </div>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#FAFAFC] text-gray-500">or sign up with email</span>
            </div>
          </div>
            ...
            <div>
              ...
              {form.password && (
                <div className="mt-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Password strength: {passwordStrength().strength}</p>
                </div>
              )}
            </div>
